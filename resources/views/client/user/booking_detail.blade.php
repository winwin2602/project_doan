                                    ...
                                    <div class="panel-body">
                                     <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><img width="60px" src="{{asset('administration/imageRooms/'.$booking_detail->room->thumbnail)}}"></td>
                                                <td>{{ $booking_detail->room->roomtypes->name }}</td>
                                                <td>
                                                    {{number_format($booking_detail->room->price)}} VND</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
